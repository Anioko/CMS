...
@opportunity.route('/<opp_id>/add/', methods=['Get', 'POST'])
@login_required
def create_opportunity(opp_id):
    ...
    if request.method == 'POST':
        if form.validate_on_submit():
            ...
            return redirect(url_for('opportunity.opportunity_details', opportunity_id=appt.id, title=appt.title,
...
@opportunity.route('/<int:opportunity_id>/<title>/<city>/<state>/<country>')
